var DataRetriever = function (vals) {
	...
	var handleFlesch = function (JSONResponse) {
		...
		if (extractPlainText != undefined && extractPlainText != null && extractPlainText != "") {
	...
	var handleEditData = function (JSONResponse) {
		...
		if (JSONrevisions != undefined) {
			...
			for (var i = 0; i < JSONrevisions.length; i++) {
				//get username:
				//console.log("HERE: " + JSON.stringify(JSONrevisions[i].user));
             ...
             //       console.log("THE TITLE: " + GLOBAL_title);
                }
			}
			...
			//	console.log("CONTINUE : " + GLOBAL_title);
